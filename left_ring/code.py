...
scan_response.complete_name = "Left Mouse Ring"
ble = adafruit_ble.BLERadio()

# set buttons
# left_BTN_input = digitalio.DigitalInOut(board.D10)
# left_BTN_input.switch_to_input(digitalio.Pull.UP)
# left_BTN = Button(left_BTN_input)
# right_BTN_input = digitalio.DigitalInOut(board.D7)
# right_BTN_input.switch_to_input(digitalio.Pull.UP)
# left_BTN = Button(right_BTN_input)
left_BTN = digitalio.DigitalInOut(board.D10)
left_BTN.direction = Direction.INPUT
left_BTN.pull = Pull.UP
right_BTN = digitalio.DigitalInOut(board.D7)
right_BTN.direction = Direction.INPUT
right_BTN.pull = Pull.UP
scrollup_BTN = digitalio.DigitalInOut(board.D9)
scrollup_BTN.direction = Direction.INPUT
scrollup_BTN.pull = Pull.UP
scrolldown_BTN = digitalio.DigitalInOut(board.D8)
...
while True:
    ...
    while ble.connected:
        ...
        if left_BTN.value is False:
            ...
            # blue_led.value = True
            # green_led.value = False
            time.sleep(0.03)  # sleep for debounce
